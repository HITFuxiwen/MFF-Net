...
def test_net(args, path):
    ...
    if path == '0':
        model_path = args.save_model_dir + '243RGB_VST_rcmt2.pth'
    else:
        model_path = path
    # model_path = args.save_model_dir + '299RGB_VST_new_res2.pth'
    ...
    for i, data_batch in enumerate(test_loader):
        ...
        # save saliency maps
        if path == '0':
            save_test_path = args.save_test_path_root + dataset + '/RGB_VST_rcmt_newswam/'
        else:
            save_test_path = args.save_test_path_root + 'temp'
