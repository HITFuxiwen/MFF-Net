...
class CMT(nn.Module):
    ...
    def forward(self, x):
        x_1_4, x_1_8, x_1_16 = self.forward_features(x)
        # print(x.shape)
        return x_1_4, x_1_8, x_1_16
...
def _create_cmt_model(pretrained=False, distilled=False, **kwargs):
    ...
    if pretrained:
        load_checkpoint(model, args.pretrained_model2, use_ema=True)
        print('Model loaded from {}'.format(args.pretrained_model2))
        # load_pretrained(
