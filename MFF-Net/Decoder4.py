...
class Mlp(nn.Module):
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.GELU, drop=0.):
        ...
        #     BasicConv2d(hidden_features, hidden_features, kernel_size=(1, 3), padding=(0, 1)),
        #     BasicConv2d(hidden_features, hidden_features, kernel_size=(3, 1), padding=(1, 0)),
        ...
        #     BasicConv2d(hidden_features, hidden_features, kernel_size=(1, 5), padding=(0, 2)),
        #     BasicConv2d(hidden_features, hidden_features, kernel_size=(5, 1), padding=(2, 0)),
        ...
        self.proj = BasicConv2d(hidden_features, hidden_features, 3, padding=1)
        ...
        self.proj_3 = nn.Conv2d(out_features, out_features, 3, 1, 1, groups=out_features)
