...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_model_dir', default='ckpt3/', type=str, help='save model path')
    ...
    parser.add_argument('--methods', type=str, default='MFF-Net', help='evaluated method name')
